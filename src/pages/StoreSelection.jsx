...
const StoreSelection = () => {
  ...
  return (
    <>
    <div className="flex h-screen m-auto max-w-[1500px] w-full max-md:m-0">
      <div className="flex flex-col border min-w-[350px] max-w-[600px] w-full border-gray-200 shadow-md">
        <div className='p-5'>
          ...
          <div className='flex flex-col gap-5'>
            <div className='flex bg-orange-200 rounded-4xl font-[sans-serif] font-bold'>
              <span className='flex justify-center w-full p-2 text-sm bg-amber-50 rounded-4xl'>
                Pickup
              </span>
              <span className='flex justify-center w-full p-2 text-sm rounded-4xl'>
                Delivery
              </span>
            </div>
            <form>
              <AddressAutofill
                ...
                onRetrieve={retrieveRes => {
                  ...
                  fetchNearBy(longitude, latitude, 5000)
                      .then(res => {
                        console.log(res);
          ...
          {stores.map(store => {
            ...
            return (
              ...
              >
                ...
                <address className='font-[sans-serif] font-semibold'>{store.branch}</address>
      ...
      <div id="map" className="flex min-w-[400px] h-screen w-full bg-gray-200" ref={mapContainerRef}>
