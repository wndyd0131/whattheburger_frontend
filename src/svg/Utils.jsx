...
export const CartIcon = ({width, height, cartHovered, setCartHovered}) => {
  return (
    <>
      {cartHovered === false ? 
        <motion.svg className="cursor-pointer" onHoverStart={() => setCartHovered(true)} width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.29977 5H21L19 12H7.37671M20 16H8L6 3H3M9 20C9 20.5523 8.55228 21 8 21C7.44772 21 7 20.5523 7 20C7 19.4477 7.44772 19 8 19C8.55228 19 9 19.4477 9 20ZM20 20C20 20.5523 19.5523 21 19 21C18.4477 21 18 20.5523 18 20C18 19.4477 18.4477 19 19 19C19.5523 19 20 19.4477 20 20Z" stroke="#FE7800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </motion.svg>
        :
        <motion.svg className="cursor-pointer" onHoverEnd={() => setCartHovered(false)} width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M7.2998 5H22L20 12H8.37675M21 16H9L7 3H4M4 8H2M5 11H2M6 14H2M10 20C10 20.5523 9.55228 21 9 21C8.44772 21 8 20.5523 8 20C8 19.4477 8.44772 19 9 19C9.55228 19 10 19.4477 10 20ZM21 20C21 20.5523 20.5523 21 20 21C19.4477 21 19 20.5523 19 20C19 19.4477 19.4477 19 20 19C20.5523 19 21 19.4477 21 20Z" stroke="#FE7800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </motion.svg>
      }
...
export const RightArrowIcon = ({width="50px", height="50px", color="#000000"}) => {
  return (
    <svg width={width} height={height} viewBox="0 0 1024 1024" className="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M256 120.768L306.432 64 768 512l-461.568 448L256 903.232 659.072 512z" fill={color} /></svg>
  );
}

export const LeftArrowIcon = ({width="50px", height="50px", color="#000000"}) => {
  return (
    <svg width={width} height={height} viewBox="0 0 1024 1024" className="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M768 903.232l-50.432 56.768L256 512l461.568-448 50.432 56.768L364.928 512z" fill={color} /></svg>
  );
}


export const HamburgerIcon = ({width="50px", height="50px", color="#000000"}) => {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" clipRule="evenodd" d="M20.75 7C20.75 7.41421 20.4142 7.75 20 7.75L4 7.75C3.58579 7.75 3.25 7.41421 3.25 7C3.25 6.58579 3.58579 6.25 4 6.25L20 6.25C20.4142 6.25 20.75 6.58579 20.75 7Z" fill={color}/>
      <path fillRule="evenodd" clipRule="evenodd" d="M20.75 12C20.75 12.4142 20.4142 12.75 20 12.75L4 12.75C3.58579 12.75 3.25 12.4142 3.25 12C3.25 11.5858 3.58579 11.25 4 11.25L20 11.25C20.4142 11.25 20.75 11.5858 20.75 12Z" fill={color}/>
      <path fillRule="evenodd" clipRule="evenodd" d="M20.75 17C20.75 17.4142 20.4142 17.75 20 17.75L4 17.75C3.58579 17.75 3.25 17.4142 3.25 17C3.25 16.5858 3.58579 16.25 4 16.25L20 16.25C20.4142 16.25 20.75 16.5858 20.75 17Z" fill={color}/>
    </svg>
  );
}

export const ListIcon = ({width="50px", height="50px", color="#000000"}) => {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const LogoutIcon = ({width="50px", height="50px", color="#000000"}) => {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ProfileIcon = ({width="50px", height="50px", color="#000000"}) => {
  return (
...
export const LoadingSpinner = ({spinnerColor="#FE7800", circleColor="#FE7800", r="50", strokeWidth="10"}) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200' width={50} height={50}><radialGradient id='a12' cx='.66' fx='.66' cy='.3125' fy='.3125' gradientTransform='scale(1.5)'><stop offset='0' stopColor={circleColor}></stop><stop offset='.3' stopColor={circleColor} stopOpacity='.9'></stop><stop offset='.6' stopColor={circleColor} stopOpacity='.6'></stop><stop offset='.8' stopColor={circleColor} stopOpacity='.3'></stop><stop offset='1' stopColor={circleColor} stopOpacity='0'></stop></radialGradient>
      <circle transform-origin='center' fill='none' stroke='url(#a12)' strokeWidth={strokeWidth} strokeLinecap='round' strokeDasharray='200 1000' strokeDashoffset='0' cx='100' cy='100' r={r}><animateTransform type='rotate' attributeName='transform' calcMode='spline' dur='2' values='360;0' keyTimes='0;1' keySplines='0 0 1 1' repeatCount='indefinite'></animateTransform>
      </circle>
      <circle transform-origin='center' fill='none' opacity='.2' stroke={spinnerColor} strokeWidth={strokeWidth} strokeLinecap='round' cx='100' cy='100' r={r}>
      </circle>
    </svg>
  );
}
...
export const LoadingSquares = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200'><rect fill='#FE7800' stroke='#FE7800' stroke-width='15' width='30' height='30' x='25' y='85'><animate attributeName='opacity' calcMode='spline' dur='2' values='1;0;1;' keySplines='.5 0 .5 1;.5 0 .5 1' repeatCount='indefinite' begin='-.4'></animate></rect><rect fill='#FE7800' stroke='#FE7800' stroke-width='15' width='30' height='30' x='85' y='85'><animate attributeName='opacity' calcMode='spline' dur='2' values='1;0;1;' keySplines='.5 0 .5 1;.5 0 .5 1' repeatCount='indefinite' begin='-.2'></animate></rect><rect fill='#FE7800' stroke='#FE7800' stroke-width='15' width='30' height='30' x='145' y='85'><animate attributeName='opacity' calcMode='spline' dur='2' values='1;0;1;' keySplines='.5 0 .5 1;.5 0 .5 1' repeatCount='indefinite' begin='0'></animate></rect>
    </svg>
  )
}
    ...
    <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="Layer_2" data-name="Layer 2">
        ...
        <g id="icons_Q2" data-name="icons Q2">
          <path d="M8,6.2V26.3A6.2,6.2,0,0,0,4,32a6,6,0,0,0,4,5.6v4.2A2.1,2.1,0,0,0,10,44a2.1,2.1,0,0,0,2-2.2V37.6A6,6,0,0,0,16,32a6.2,6.2,0,0,0-4-5.7V6.2A2.1,2.1,0,0,0,10,4,2.1,2.1,0,0,0,8,6.2ZM12,32a2,2,0,1,1-2-2A2,2,0,0,1,12,32Z"/>
          <path d="M22,6.2v4.1A6.2,6.2,0,0,0,18,16a6,6,0,0,0,4,5.6V41.8a2,2,0,1,0,4,0V21.6A6,6,0,0,0,30,16a6.2,6.2,0,0,0-4-5.7V6.2a2,2,0,1,0-4,0ZM26,16a2,2,0,1,1-2-2A2,2,0,0,1,26,16Z"/>
          <path d="M36,6.2V23.3A6.2,6.2,0,0,0,32,29a6,6,0,0,0,4,5.6v7.2a2,2,0,1,0,4,0V34.6A6,6,0,0,0,44,29a6.2,6.2,0,0,0-4-5.7V6.2a2,2,0,1,0-4,0ZM40,29a2,2,0,1,1-2-2A2,2,0,0,1,40,29Z"/>
        </g>
      </g>
    </svg>
  )
